...
const ExcelReport = (props) => {
    const { _btn_style,_data,_file_name,_hideElement,_id,_sheets } = props;
  ...
  return (
    <ExcelFile hideElement={_hideElement} filename={_file_name} element={<button className={_btn_style} id={_id} >{props.children}</button>}>
        <ExcelSheet dataSet={display_data} name="MODEC"/>
        {_sheets?<ExcelSheet dataSet={_sheets} name="_blank"/>:<ExcelSheet dataSet={default_data} name="_blank"/>}
    </ExcelFile>
  )
}
