...
function AddLocGroup({ _callback,_onCloseClick ,_loctype_id }){
  ...
  async function onSubmit(e) {
    ...
    _dataService.CRUD(window.base_api+`location_groups/add`,requestOptions, async (response)=>{
  ...
  function processExcel (e){
    ...
    _dataService.processExcel(
      `location_group/download_excel_template_location_group.php`,
      body,
      "Batch_Add_location_group_Template",
      (return_data)=>{          
