...
const EditModule = (props) => {   
    ...
    const { _state, _callback,_id,_accessLevel } = props; 
    ...
    async function _getRecords(user,callback){
        ...
        if(token && token_creation){
            ...
            _dataService.CRUD(window.base_api+`get_al_modules/${_id}`,requestOptions, async (response)=>{
    ...
    async function onSubmit(e) {
        ...
        _dataService.CRUD(window.base_api+`update_al_modules/${_id}`,requestOptions, async (response)=>{
    ...
    async function onRemove(e){
        ...
        // When a post request is sent to the create url, we'll add a new record to the database.
        const _payload = {
            payload: { ...form,access_level:_accessLevel },
            auth: { token: token, _id: _user_id, _fullname: _fullname },
        };
        ...
        _dataService.CRUD(window.base_api+`remove_al_modules/${_id}`,requestOptions, async (response)=>{
