...
const EditLoctype = ({ _id ,_onCloseClick, _callback }) => {    
    ...
    async function _getRecords(user,callback){
        ...
        _dataService.CRUD(window.base_api+`get_loctype/${_id}`,requestOptions, async (response)=>{
    ...
    async function onSubmit(e) {
        ...
        _dataService.CRUD(window.base_api+`update_loctype/${_id}`,requestOptions, async (response)=>{
