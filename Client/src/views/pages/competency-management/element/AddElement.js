...
const AddElement = (props) => {
  ...
  async function onSubmit(e) {
    ...
    _dataService.CRUD(window.base_api+`elements/add`,requestOptions, async (response)=>{
